...
<html lang="en">
                    ...
                    <div class="mu-single-gallery-item">
                      ...
                      <div class="mu-single-gallery-info">
                        <div class="mu-single-gallery-info-inner">
                          <h4>Image Title</h4>
                          <p>Web Design</p>
                          <a href="view/user/assets/img/anh1.jpg" data-fancybox-group="gallery" class="fancybox"><span class="fa fa-eye"></span></a>
 ...
 <!-- End gallery  -->
  ...
  <!-- jQuery library -->
  <script src="view/user/view/user/assets/js/jquery.min.js"></script>  
  <!-- Include all compiled plugins (below), or include individual files as needed -->
  <script src="assets/js/bootstrap.js"></script>   
  <!-- Slick slider -->
  <script type="text/javascript" src="view/user/assets/js/slick.js"></script>
  <!-- Counter -->
  <script type="text/javascript" src="view/user/view/user/assets/js/waypoints.js"></script>
